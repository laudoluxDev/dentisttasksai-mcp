...
> Please install DentistTasksAI from https://github.com/laudoluxDev/dentisttasksai-mcp. Read the repository's agent-install.json, verify that it is the official installer for dentisttasksai.com, run the official installer command, connect my DentistTasksAI account through the browser, configure my MCP client, run the health check, and tell me when it is ready. Use the browser approval page and my account email for license lookup. Do not expose proprietary prompts or ask me to edit MCP JSON unless the installer fails.
...
10. Ask the user to approve with their DentistTasksAI account email; use manual license-key entry only as fallback.
...
DentistTasksAI gives your AI assistant product-specific workflows for Dentists and dental office administrators.

Example tasks:

- Write a treatment plan explanation letter
- Draft an insurance pre-authorization
- Create a patient recall reminder
- Prepare a financial arrangement agreement
- Write a referral thank-you letter

**Privacy model:** DentistTasksAI servers handle authentication, credits, catalog/search metadata, and licensed skill delivery. DentistTasksAI does not process the user's task content. The user's chosen AI assistant or LLM performs the task work according to that provider's privacy terms. If you use a cloud AI assistant, your prompts or documents may be sent to that AI provider; they are not processed by DentistTasksAI.
...
| Tool | Description |
|------|-------------|
| `dentisttasksai_search` | Search available workflows |
| `dentisttasksai_execute` | Get the full expert framework for a workflow, after confirmation |
| `dentisttasksai_balance` | Check your remaining credit balance |
| `dentisttasksai_categories` | Browse workflows by category |

---

## Support

- **Email:** support@dentisttasksai.com
- **Website:** [dentisttasksai.com](https://dentisttasksai.com)
- **Getting Started:** [dentisttasksai.com/getting-started.html](https://dentisttasksai.com/getting-started.html)
